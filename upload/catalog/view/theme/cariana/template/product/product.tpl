...
<div itemscope itemtype="http://schema.org/Product">
  ...
  <div class="product-info">
  	<div class="row">
  	     <center><a target="_blank" href="http://gccworld.info/doc/cariana/"><b><u>Theme Installation Error: Delete Cache or Re-Download and re-upload or check documentation here</u></b></a></center>
			     ...
			     <div id="product">
			      ...
			      <div class="cart">
			        ...
			        <div class="links clearfix">
			        	<ul>
                        <li><i class="fa fa-heart-o"></i><a onclick="wishlist.add('<?php echo $product_id; ?>');"><?php if($theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to wishlist'; } ?></a></li>
<li>			        	<i class="fa fa-refresh"></i><a onclick="compare.add('<?php echo $product_id; ?>');"><?php if($theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to compare'; } ?></a>
			        </li>
                    </ul>
                    </div>
