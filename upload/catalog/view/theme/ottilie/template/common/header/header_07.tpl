			...
			<div class="background">
				...
				<div class="pattern">
				     <div class="top-bar">
                          ...
                          <div class="phone"> OUR PHONE NUMBER: +77 (756) 334 876</div>
				               <!-- Links -->
				               <ul class="menu">
				               	<li><i class="fa fa-user"></i><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></li>
				               	<li><i class="fa fa-heart-o"></i><a href="<?php echo $wishlist; ?>" id="wishlist-total"><?php echo $text_wishlist; ?></a></li>
				               	<li><i class="fa fa-shopping-cart"></i><a href="<?php echo $shopping_cart; ?>"><?php echo $text_shopping_cart; ?></a></li>
				               	<li><i class="fa fa-check-square-o"></i><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></li>
				               		<?php if ($logged) { ?>
					...
					if( count($menu2) ) { 
						...
						echo '</div>';
							...
							<!-- Header Left -->
							<div class="col-sm-4" id="header-mid">
							     <?php if ($logo) { ?>
							     <!-- Logo -->
